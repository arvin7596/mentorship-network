...
public class PostController {
    ...
    @PostMapping
    public ResponseEntity<PostDTO> createPost(@RequestBody PostService.CreatePostRequest request) {
        PostDTO createdPost = postService.createPost(request);
        return ResponseEntity.status(HttpStatus.CREATED).body(createdPost);
    }

    @PutMapping("/{id}")
    public ResponseEntity<Post> updatePost(@PathVariable Long id, @RequestBody PostService.UpdatePostRequest request) {
